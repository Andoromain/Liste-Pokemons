...
const Card = (props) => {
    const { pokemon, labelButton, clickButton } = props;
        ...
        <div className="flex flex-col justify-center p-10 bg-white rounded-lg shadow-2xl card">
            ...
            <div className="grid gap-10 prod-info">
                ...
                <div className="w-full p-0 mb-2 bg-pink-100 rounded-lg dark:bg-white">
                    <div className="flex flex-wrap items-center justify-between text-xs text-gray-400 dark:text-black">
                        <p className="flex flex-col flex-wrap mx-1">
                            HP
                        ...
                        <p className="flex flex-wrap flex-col mx-1">
                            Defense
                            <span className="font-bold text-black dark:text-indigo-500">
